...
class CreateTipolistapreciosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tipolistaprecios', function (Blueprint $table) {
            ...
            $table->foreign('idEstado', 'TipoListaPrecios_FK')->references('id')->on('estados');
        });
    }
    ...
    {
        Schema::dropIfExists('tipolistaprecios');
    }
}
