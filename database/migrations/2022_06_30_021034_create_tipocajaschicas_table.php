...
class CreateTipocajaschicasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tipocajaschicas', function (Blueprint $table) {
            ...
            $table->foreign('idEstado', 'TipoCajasChicas_FK')->references('id')->on('estados');
        });
    }
    ...
    {
        Schema::dropIfExists('tipocajaschicas');
    }
}
