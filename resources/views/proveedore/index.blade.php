                                ...
                                <tbody>
                                    @foreach ($proveedores as $proveedore)
                                        <tr>
											...
											<td>{{ $proveedore->NombreFantasia }}</td>
											<td>{{ $proveedore->idPaises }}</td>
											<td>{{ $proveedore->idCiudades }}</td>
											<td>{{ $proveedore->Direccion }}</td>
											<td>{{ $proveedore->idTiposProveedores }}</td>
											<td>{{ $proveedore->idEstado }}</td>
